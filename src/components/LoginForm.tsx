  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-[400px]">
        ...
        <div className="rounded-[28px] border border-[rgba(0,0,0,0.06)] bg-gray-50/90 p-8 sm:p-10 animate-fade-in-up [animation-delay:75ms] [animation-fill-mode:backwards]">
