...
const nav = [
  ...
  },
  {
    ...
    label: 'Providers',
    icon: Phone,
    match: (p: string) => p.startsWith('/renovation/providers'),
  },
  {
  ...
  },
  {
    ...
    label: 'Needs',
    icon: Star,
    match: (p: string) => p.startsWith('/renovation/needs'),
  },
  {
    href: '/renovation/wishlist',
    label: 'Wishlist',
    icon: ShoppingCart,
    match: (p: string) => p.startsWith('/renovation/wishlist'),
  },
  {
    href: '/renovation/rooms',
    label: 'Rooms',
    icon: DoorOpen,
    match: (p: string) => p.startsWith('/renovation/rooms'),
  },
  {
    href: '/renovation/settings',
    label: 'Settings',
    icon: Settings,
    match: (p: string) => p.startsWith('/renovation/settings'),
  },
]
