                ...
                >
                  {attachment.file_type === 'image' ? (
                    ...
                    <div className="w-full h-full bg-slate-100 flex flex-col items-center justify-center p-1">
                      ...
                      <p className="text-[10px] font-medium text-slate-600 mt-1 px-1 text-center truncate w-full">
                        {attachment.file_name.length > 15 
                          ? `${attachment.file_name.substring(0, 15)}...` 
                          : attachment.file_name}
                      </p>
              ...
              {property.contact_phone && (
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => { e.stopPropagation(); }}
                    className="flex items-center justify-center w-6 h-6 rounded-full bg-green-500 hover:bg-green-600 transition-colors text-white flex-shrink-0"
